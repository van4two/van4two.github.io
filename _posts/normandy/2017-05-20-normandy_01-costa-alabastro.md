...
day: "01"
teaser: /assets/img/2017-05-20-normandy/teaser/01.jpg
---

{% google_photos page.gallery_url none %}

{% include img.html img="2017.05.20 - 13. cote alabatre.jpg" cap="Spiaggia delimitata dalle alte scogliere d’alabastro nei pressi di Veules-les-Roses" %}
...
{% include img.html img="2017.05.20 - 01. picardy.jpg" cap="Campi di grano lungo la strada verso la costa" %}
...
{% include img.html img="2017.05.20 - 05. veules.jpg" cap="La Veules 'le plus petit fleuve de France'" %}
 
{% include img.html img="2017.05.20 - 07. veules.jpg" cap="Mulino ad acqua lungo il corso della Veules" %}

{% include img.html img="2017.05.20 - 10. cote alabatre.jpg" cap="La Côte d'Albâtre durante la bassa marea" %}
...
{% include img.html img="2017.05.20 - 33. cap fagnet.jpg" cap="Scogliere d’alabastro viste da Cap Fagnet" %}

{% include img.html img="2017.05.20 - 37. cap fagnet.jpg" cap="Chapelle Notre-Dame du Salut a Cap Fagnet" %}
...
{% include img.html img="2017.05.20 - 44. falaise d'aval.jpg" cap="Scogliere d’alabastro presso la falaise d’Aval" %}

{% include img.html img="2017.05.20 - 45. falaise d'aval.jpg" cap="La falaise d’Aval con la guglia e la caratteristica formazione a proboscide di elefante" %}

{% include img.html img="2017.05.20 - 15. cote alabatre.jpg" cap="Gabbiani in riva al mare" %}
...
{% include img.html img="2017.05.20 - 49. le havre.jpg" cap="Tramonto su Le Havre" %}
