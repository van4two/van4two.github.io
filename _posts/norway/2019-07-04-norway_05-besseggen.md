...
gallery_url: https://photos.app.goo.gl/WaVfViBWVPPmFRvm6
pics: 2019-06-30-norway
day: "05"
teaser: /assets/img/2019-06-30-norway/teaser/05.jpg
...
{% include img.html id=19 cap="Costeggiando il lago Bessvatnet verso la cresta Besseggen" %}
...
{% include img.html id=3 cap="Guidando lungo la Rv51 verso il lago Gjende, comincia a nevicare" %}

{% include img.html id=1 cap="Il ferry per Memurubu parte dal piccolo molo posto di fronte al rifugio Gjendesheim" %}
...
{% include img.html id=6 cap="In 20' di navigazione il ferry ci porta alla partenza dell'itinerario, in corrispondenza del rifugio Memurubu" %}
...
{% include img.html id=13 cap="Dopo il primo tratto in salita in mezzo al verde, cominciamo ad addentrarci in aree spolverate di neve" %}
...
{% include img.html id=7 cap="Al termine della prima lunga salita il percorso passa in prossimità di un piccolo specchio d'acqua con il monte Besshø sullo sfondo" %}
...
{% include img.html id=12 cap="L'acqua del ruscello che si incontra subito dopo il lago Bjørnbøltjønne è potabile" %}
...
{% include img.html id=10 cap="La vista sul lago Gjende dall'intenso colore verde acqua è spettacolare" %}

{% include img.html id=17 cap="Posto a quota 1374, il lago Bessvatnet si trova quasi 400 m più in alto del lago Gjende. Sulla destra si staglia la cresta Besseggen" %}
...
{% include img.html id=11 cap="La vista dei due laghi Gjende, dall'intenso color verde acqua, e Bessvatnet, dal tono blu scuro, posti a quote differenti, con i rilievi dello Jotunheimen National Park sullo sfondo, è impagabile" %}
...
{% include img.html id=16 cap="La sezione principale del Besseggen si svolge lungo la cresta che funge da spartiacque fra il lago Bessvatnet (nella foto) e il lago Gjende" %}
...
{% include img.html id=27 cap="La progressione sulla cresta Besseggen prevede una 'quasi' arrampicata: per quanto semplice, in alcuni tratti è necessario aiutarsi anche con le mani. Il vento che soffia forte sulla cresta non è da sottovalutare" %}

{% include img.html id=20 cap="Dalla cresta Besseggen si gode di una magnifica vista sul lago Gjende. Di tanto in tanto il ferry Gjendesheim-Memurubu attraversa, solitario, lo spettacolare specchio d'acqua" %}
...
{% include img.html id=25 cap="Scendendo verso lo Gjendesheim si può ancora godere di magnifiche viste sul lago Gjende" %}
