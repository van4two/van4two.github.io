...
{% include img.html id=75 cap="Avvicinandoci alla Trollveggen lungo la E136 nella vallata di Romsdalen" %}
...
{% include img.html id=77 cap="L'imponente Trollveggen avvolta dalle nuvole" %}

{% include img.html id=78 cap="Il troll è il più caratteristico degli esseri soprannaturali della tradizione norvegese: si dice risieda nell'ombra e nell'oscurità delle fitte foreste e dei fiordi profondi. La Trollveggen è, appunto, la 'parete dei troll'" %}
...
{% include img.html id=85 cap="Panorama lungo l'Atlanterhavsveien" %}
...
{% include img.html id=84 cap="Una casa di legno di pescatori lungo l'Atlanterhavsveien" %}
...
{% include img.html id=83 cap="Il ponte curvo Storseisundbrua lungo l'Atlanterhavsveien" %}
...
{% include img.html id=87 cap="L'allegro e raccolto porticciolo di Bud, al termine dell'Atlanterhavsveien" %}

{% include img.html id=86 cap="Il molo di una casa di legno di pescatori lungo l'Atlanterhavsveien" %}

{% include img.html id=88 cap="Gabbiani raccolti su una delle case di legno sul mare a Bud" %}
