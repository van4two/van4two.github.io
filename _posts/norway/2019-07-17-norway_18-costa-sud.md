...
gallery_url: https://photos.app.goo.gl/NzYtR4i9TwtQkKs26
...
{% include img.html id=1 cap="Panoramica sulla costa meridionale della Norvegia nei pressi di Egersund" %}
...
{% include img.html id=2 cap="Il bucolico paesino di Sogndalstrand" %}

{% include img.html id=6 cap="Il bucolico paesino di Sogndalstrand" %}

{% include img.html id=7 cap="Il bucolico paesino di Sogndalstrand" %}
...
{% include img.html id=10 cap="Vecchie ripide rotaie nei pressi di Jøssingfjord" %}
...
{% include img.html id=11 cap="Il tranquillo e appartato lago di Kollfattjødn" %}
...
{% include img.html id=18 cap="Il punto più meridionale della Norvegia si trova nella penisola di Lindesnes" %}
...
{% include img.html id=13 cap="Dalla penisola di Lindesnes, l'omonimo faro sorveglia il Mare del Nord" %}
