...
{% include img.html id=16 cap="Risveglio in riva al lago Nisser" %}
...
{% include img.html id=17 cap="A quanto pare le Jettegrytene non sono al momento raggiungibili" %}
...
{% include img.html id=18 cap="L'accesso principale al teatro avviene dal livello inferiore" %}
...
{% include img.html id=24 cap="L'interno del teatro dell'opera è realizzato impiegando principalmente legno di quercia" %}
...
{% include img.html id=20 cap="La scultura di vetro e acciaio Hun Ligger si trova di fronte al teatro dell'opera, in mezzo all'acqua" %}

{% include img.html id=25 cap="L'installazione sul lungomare ad ovest del teatro dell'opera" %}
