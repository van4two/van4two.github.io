...
gallery_url: https://photos.app.goo.gl/C8zFXit5nEkjem7DA
pics: 2019-06-30-norway
day: "12"
teaser: /assets/img/2019-06-30-norway/teaser/12.jpg
---

{% google_photos page.gallery_url none %}

{% include img.html id=7 cap="Di fronte al lago Hornsvatnet lungo la Snøvegen" %}
...
{% include img.html id=2 cap="Di fronte al lago Flotvatnet lungo la Snøvegen" %}
...
{% include img.html id=5 cap="Una piccola costruzione rossa spicca nei pressi del lago Hornsvatnet, lungo la Snøvegen" %}
...
{% include img.html id=10 cap="Scorcio sull'Aurlandsfjord dal belvedere Stegastein" %}

{% include img.html id=11 cap="La struttura in legno del moderno belvedere Stegastein" %}
...
{% include img.html id=13 cap="Scorcio sull'Aurlandsfjord dalla strada che va verso Flåm" %}
...
{% include img.html id=14 cap="Nave da crociera attraccata nel porto di Flåm" %}

{% include img.html id=15 cap="Nave da crociera attraccata nel porto di Flåm" %}
...
{% include img.html id=16 cap="Lo stretto e profondo Næroyfjord, patrimonio UNESCO" %}
...
{% include img.html id=19 cap="Kayak in attesa a Gudvangen, in fondo al Næroyfjord" %}
