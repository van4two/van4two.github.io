...
{% include img.html id=291 cap="Il Kjeragbolten, ovvero il 'masso del monte Kjerag', si presenta ben incastrato alla sommità di due pareti di granito a picco sul fiordo" %}
...
{% include img.html id=291 cap="All'accesso del ripido sentiero che conduce al Kjeragbolten" %}

{% include img.html id=291 cap="Il sentiero che conduce al Kjeragbolten, seguendo cavi metallici, a poco a poco si alza sopra le nuvole" %}
...
{% include img.html id=291 cap="Lungo l'itinerario troviamo sporadiche tende di escursionisti che si accingono a visitare il Kjeragbolten" %}
...
{% include img.html id=291 cap="Nei pressi del Kjeragbolten si apre una spettacolare e vertiginosa vista sul Lysefjord" %}
...
{% include img.html id=291 cap="L'accesso al Kjeragbolten avviene da una breve e precaria cengetta" %}

{% include img.html id=291 cap="Un cartello indica come disporsi per accedere al Kjeragbolten in sicurezza: fortunatamente, al nostro arrivo, di primo mattino, non troviamo nessuno" %}
...
{% include img.html id=291 cap="Il luminoso Lysefjord catturato da Lysebotn; anche se non visibili da questo punto, il Kjeragbolten si trova sulla sponda sinistra e il Preikestolen più in fondo su quella destra" %}
...
{% include img.html id=291 cap="Attraversando un nastro di alti fili d'erba verde, dal campeggio di Ogna raggiungiamo la spiaggia" %}
...
{% include img.html id=291 cap="La sabbia sottile della spiaggia di Ogna" %}
