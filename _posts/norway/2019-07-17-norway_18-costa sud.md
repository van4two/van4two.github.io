...
{% include img.html img="IMGP5776 - egersund.jpg" cap="Panoramica sulla costa meridionale della Norvegia nei pressi di Egersund" %}
...
{% include img.html img="IMGP5787 - sogndalstrand.jpg" cap="Il bucolico paesino di Sogndalstrand" %}

{% include img.html img="IMGP5798 - sogndalstrand.jpg" cap="Il bucolico paesino di Sogndalstrand" %}

{% include img.html img="IMGP5808 - sogndalstrand.jpg" cap="Il bucolico paesino di Sogndalstrand" %}
...
{% include img.html img="IMGP5814 - jøssingfjord.jpg" cap="Vecchie ripide rotaie nei pressi di Jøssingfjord" %}
...
{% include img.html img="IMGP5822 - kollfattjødn.jpg" cap="Il tranquillo e appartato lago di Kollfattjødn" %}
...
{% include img.html img="IMG_20190717_180540 - lindesnes.jpg" cap="Il punto più meridionale della Norvegia si trova nella penisola di Lindesnes" %}
...
{% include img.html img="IMG_20190717_173759 - lindesnes.jpg" cap="Dalla penisola di Lindesnes, l'omonimo faro sorveglia il Mare del Nord" %}
