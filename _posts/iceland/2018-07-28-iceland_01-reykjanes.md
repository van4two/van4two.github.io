...
{% include img.html id=0 cap="Preparativi: attrezzatura fotografica e abbigliamento tecnico" %}
...
{% include img.html id=0 cap="Arrivo al Keflavik International Airport" %}
...
{% include img.html id=0 cap="Il faro più antico, risalente alla fine del XIX secolo" %}

{% include img.html id=0 cap="Il faro eretto nel 1944 in posizione arretrata rispetto alla costa" %}
...
{% include img.html id=0 cap="L’esplosione di colori di Krisúvík" %}
...
{% include img.html id=0 cap="Avvicinandosi alle solfatare si viene avvolti da fumo caldo dall’odore 'importante'" %}

{% include img.html id=0 cap="Il terreno dell’area di Krisúvík mostra meravigliose sfumature cromatiche" %}

{% include img.html id=0 cap="Le acque sulfuree dei rivoli e delle pozze hanno temperature estremamente elevate" %}
...
{% include img.html id=0 cap="La strada n. 42 costeggia la sponda occidentale del lago Kleifarvatn" %}

{% include img.html id=0 cap="La distesa di muschio verdissimo lungo la strada n. 417, ancora all’interno della riserva naturale di Reykjanesfólkvangur " %}
