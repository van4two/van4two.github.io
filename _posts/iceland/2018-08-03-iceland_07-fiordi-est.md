...
day: "07"
teaser: /assets/img/2018-07-28-iceland/teaser/07.jpg
---

{% include img.html img="IMGP8116.jpg" cap="Pulcinella di mare nella colonia di Borgarfjörður Eystri" %}
...
{% include img.html img="IMGP8332.jpg" cap="Il porticciolo Borgarfjarðarhöfn costituisce il punto di accesso alla colonia di pulcinella di mare" %}
...
{% include img.html img="IMGP8084.jpg" cap="Un gabbiano tridattilo protegge il suo piccolo nel nido ricavato sulla scogliera" %}

{% include img.html img="IMGP8091.jpg" cap="Due gabbiani tridattili litigano emettendo versi estremamente acuti" %}
...
{% include img.html img="IMGP8345.jpg" cap="La colonia di Borgarfjarðarhöfn conta numerosissimi esemplari di puffins" %}

{% include img.html img="IMGP8191.jpg" cap="Molti pulcinella di mare si stagliano pressoché immobili accanto alla propria tana" %}
...
{% include img.html img="IMGP8218.jpg" cap="Pulcinella di mare" %}

{% include img.html img="IMGP8298.jpg" cap="Il bottino della pesca" %}
...
{% include img.html img="IMGP8504.jpg" cap="Pulcinella di mare" %}
...
{% include img.html img="IMGP8520.jpg" cap="Scorci lungo la strada n. 94 che da Borgarfjörður Eystri riporta ad Egilsstaðir" %}
...
In breve raggiungiamo il parcheggio della cascata mentre il cielo si copre di nuvole scure e comincia a piovere. Percorriamo a piedi il breve sentiero per [**Dettifoss**](https://www.introducingiceland.com/dettifoss) che vediamo, imponente, sotto la pioggia. Le altre due cascate sono a breve distanza ma la pioggia si fa insistente, costringendoci a dirigerci direttamente verso Mývatn. Torniamo sul Ring e, poco prima della nostra destinazione, svoltiamo a destra per visitare l’area di Krafla. 
