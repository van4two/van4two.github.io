...
Ci dirigiamo verso l'ingresso dello State park della [**Valley of Fire**](http://parks.nv.gov/parks/valley-of-fire). Qui, accanto alla formazione rocciosa dell’[**Elephant rock**](https://www.valley-of-fire.com/elephant-rock/), troviamo una buchetta dove inserire in autonomia l'obolo di 10 $ per accedere al parco con l'auto.

{% include img.html img="IMGP5982 - valley of fire.jpg" cap="Valley of Fire highway" %}
...
{% include img.html img="IMGP5992 - valley of fire.jpg" cap="Bighorn sheep" %}

{% include img.html img="IMGP6005 - prickly pear.jpg" cap="Prickly pear cactus" %}
...
{% include img.html img="IMGP6144 - neonopolis.jpg" cap="Il quartiere di Neonopolis, non lontano dalla Strip" %}
## The Strip
