...
pics: 2022-04-25-usa
day: "02"
teaser: /assets/img/2022-04-25-usa/teaser/02.jpg
...
{% include img.html img="IMGP4096 - cedar ridge.jpg" cap="A cavallo presso il Cedar ridge lungo il South Kaibab trail" %}
...
{% include img.html img="IMGP4085 - cedar ridge.jpg" cap="Vista del Grand Canyon presso il Cedar ridge" %}

{% include img.html img="IMGP4100 - south kaibab.jpg" cap="Vista del Grand Canyon presso il Cedar ridge" %}
...
{% include img.html img="IMGP4114 - south kaibab.jpg" cap="Lungo il South Kaibab trail" %}

{% include img.html img="IMGP4130 - south kaibab.jpg" cap="Lungo il South Kaibab trail" %}
...
{% include img.html img="IMGP4158 - tipoff.jpg" cap="In vista del Tipoff" %}

{% include img.html img="IMGP4179 - tipoff.jpg" cap="Muli in fila indiana presso il Tipoff" %}
...
{% include img.html img="IMGP4233 - colorado river.jpg" cap="Verso le rapide del Colorado river" %}
...
{% include img.html img="IMGP4263 - phantom ranch.jpg" cap="L'invitante Phantom ranch" %}

{% include img.html img="IMGP4258 - phantom ranch.jpg" cap="Scoiattolo in cerca di cibo presso il Phantom ranch" %}
...
{% include img.html img="IMGP4264 - bright bridge.jpg" cap="Sul Bright bridge" %}
...
{% include img.html img="IMGP4208 - pink hedgehog cactus.jpg" cap="Pink hedgehog cactus" %}

{% include img.html img="IMGP4245 - prickly pear.jpg" cap="Prickly pear cactus" %}
...
{% include img.html img="IMGP4276 - indian garden.jpg" cap="Lasciandoci alle spalle l'Indian garden" %}
